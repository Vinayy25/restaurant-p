            ...
            <div class="m-50">
                <div class="mt-5 mb-3">
                    ...
                    <form method="POST" action="#">
                        <div class="row">
                            <div class="col-md-6">
                                <input required type="text" id="search" name="search" class="form-control" placeholder="Enter Bill ID, Table ID">
                            </div>
                            <div class="col-md-3">
                ...
                if (isset($_POST['search'])) {
                    if (!empty($_POST['search'])) {
                        ...
                        $sql = "SELECT * FROM Bills WHERE table_id LIKE '%$search%' OR bill_id LIKE '%$search%'";
                    } else {
