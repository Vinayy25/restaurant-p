        ...
        <div class="row">
            <div class="m-50">
                <div class="mt-5 mb-3">
                    ...
                    <a href="../staffCrud/create_staff_verify.php" class="btn btn-outline-dark"><i class="fa fa-plus"></i> Add Staff</a>
                </div>
                <div class="mb-3">
                    ...
                    if (mysqli_num_rows($result) > 0) {
                       ...
                       echo "<th>Update</th>";
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                           ...
                           echo "</td>";
                           echo "<td>";
                        //    $update_sql = "UPDATE staff SET staff_name=?, role=?, staff_id=?, account_id=? WHERE staff_id=?";
                           echo '<a href="../staffCrud/update_staff_verify.php?id='. $row['staff_id'] .'" title="Modify Record" data-toggle="tooltip"'
