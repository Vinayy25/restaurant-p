...
$sqlsides = "SELECT * FROM Menu WHERE item_category = 'Starters' ORDER BY item_type; ";
    ...
    <div class="nav-bar">
      <div class="brand">
          <a class="nav-link" href="../home/home.php#hero">
            <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;">Cheesy!</h1><span class="sr-only"></span>
          </a>
      </div>
      <div class="nav-list">
        <div class="hamburger">
...
<section id="hero" style="position: relative;">
    <video autoplay loop muted playsinline poster="your-poster-image.jpg" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover;">
        <source src="../image/frontpagevedio.mp4" type="video/mp4">
    ...
    <div class="hero container" style="position: relative; z-index: 1;">
        <div>
            <h1><strong><h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;">Take it</h1><span></span></strong></h1>
            <h1><strong style="color:white;">Cheesy!<span></span></strong></h1>
...
<!-- End Hero Section -->
  ...
  <section id="projects">
    ...
    <div class="red msg">
        <div></div>
      <div class="sideDish">
           <h1 style="text-align:center">Starters</h1>
...
<section id="about" ">
  <div class="about container">
    <div class="col-right">
        ...
        <h2>Take it cheesy History:</h2>
 <p>
"Take it Cheesy" isn't just a restaurant; it's an expedition through India's vibrant culinary landscape. Situated amidst lively streets, this authentic Indian eatery ignites the senses with its aromatic spices, dynamic flavors, and time-honored cooking methods passed down through generations. Each dish, from the sizzling tandoori specialties to the creamy curries and crispy dosas, embodies a tribute to India's rich gastronomic heritage.
 </p>
 <p>Whether you're a fervent admirer of spice or seeking solace in a hearty meal, our diverse menu caters to all palates. From the fiery thrill-seekers to those craving comfort, there's something to tantalize every taste bud. Step into our inviting ambiance, where the scent of freshly baked naan intermingles with the joyous chatter of contented diners, creating an atmosphere of warmth and conviviality.
 </p>
 <p>At "Take it Cheesy," we extend a warm invitation to embark on a culinary odyssey that promises to leave a lasting impression. Come, indulge in a gastronomic adventure that will undoubtedly leave you yearning for more. Take a bite and immerse yourself in the true essence of Indian cuisine at "Take it Cheesy."
 </p>
  </div>
    </div>
  </section>
    ...
    <div class="contact-items">
      ...
      <div class="contact-item contact-item-bg">
        <div class="contact-info">
          ...
          <h1>Address</h1>
          <h2>Near Madhwa Vadiraja College Bantakal Udupi</h2>
        </div>
      </div>
    </div>
  </div>
